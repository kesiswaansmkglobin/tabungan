...
# 5. Queue worker (must always run)
...
| Task | Command |
|---|---|
| Run all tests | `php artisan optimize:clear && php artisan test && php artisan optimize` |
| Run a specific test | `php artisan optimize:clear && php artisan test --filter=TransactionTest && php artisan optimize` |
